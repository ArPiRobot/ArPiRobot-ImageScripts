...
debootstrap --arch=armhf --variant=buildd --merged-usr $codename ./bootstrap-armv6 http://raspbian.raspberrypi.org/raspbian/
rm -rf ./sysroot-armv6
mkdir ./sysroot-armv6
...
sudo debootstrap --arch=arm64 --variant=buildd --merged-usr $codename ./bootstrap-aarch64
